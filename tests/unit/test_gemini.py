...
from mail_todo.application.contracts import EmailExtraction, ThreadContext
from mail_todo.domain import EmailEnvelope
from mail_todo.infrastructure.config import GeminiSettings
from mail_todo.infrastructure.gemini import (
    EXTRACTION_SCHEMA,
    SYSTEM_INSTRUCTION,
