...
| **Route Classifier & Intent Extraction** | [`openrouter.py`](../../../src/cowork_agent/integrations/llm/providers/openrouter.py) / [`gemini.py`](../../../src/cowork_agent/integrations/llm/providers/gemini.py) | Evaluates truncated email bodies to classify actionability, internal terms, and knowledge sufficiency. |
...
| **Action Plan Generator & Resilient LLM** | OpenRouter, Gemini, and last-resort adapters | Synthesizes bounded context and uses the configured fallback hierarchy. |
