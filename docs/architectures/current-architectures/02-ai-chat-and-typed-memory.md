...
| **Chat Configuration Boundary** | [`config.py`](../../../src/cowork_agent/config.py), [`app.py`](../../../src/cowork_agent/app.py) | `app.py` loads the runtime environment before chat composition. Chat settings, Calendar settings, and the optional Gemini last-resort parser only validate the resulting mapping or `os.environ`; they perform no dotenv I/O ([ADR-017](../../../tasks/adr/ADR-017-settings-parsing-is-pure.md)). |
...
| **Report Artifact & PDF Ports** | [`domain/report_artifacts.py`](../../../src/cowork_agent/domain/report_artifacts.py), [`persistence/report_artifacts.py`](../../../src/cowork_agent/persistence/report_artifacts.py), [`integrations/report_pdf`](../../../src/cowork_agent/integrations/report_pdf) | `ChatController` writes generated Markdown through the injected `ReportArtifactStore`. `Fpdf2ReportPdfRenderer` implements the separate export port with four bundled Noto Sans styles; both dependencies are fields of typed `CoworkRuntime` and no report path or renderer lives on an untyped app-state slot ([ADR-018](../../../tasks/adr/ADR-018-report-pdfs-use-fpdf2-and-bundled-noto-sans.md)). |
